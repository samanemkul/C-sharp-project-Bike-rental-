        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
             ...
             <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="bikemonitoring.php" class="nav-link"  style="background-color: #fd7e14; color: white;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Monitoring</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bike Monitoring Data table</h3> 
                              ...
                              <div class="card-body">
                               ...
                               <div class="form-group">
                                 <label for="exampleInputEmail1">Client</label>
                                  <input type="text" class="form-control" id="" name="category_name" placeholder="Enter Client Name..">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Longitude</label>
                                  <input type="text" class="form-control" id="" name="longitude" placeholder="Enter Longitude ..">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Latitude</label>
                                  <input type="text" class="form-control" id="" name="latitude" placeholder="Enter Latitude ..">
                                </div>
                              </div>
                          </div>
