      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
             <a href="memberinformation.php" class="nav-link" style="background-color: #fd7e14; color: white;">
          ...
          <li class="nav-item">
            <a href="memberrental.php" class="nav-link">
              <i class="nav-icon fas fa-biking"></i>
              <p>
                Rental
              </p>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bike Information Data table</h3> 
                 <a href="memberrental.php"><button type="button" class="btn btn-info btn-sm"  style="margin-left:68%"><i class="fa fa-bicycle"> Rent </i></button></a>
