    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="clientmanagement.php" class="nav-link" style="background-color: #fd7e14; color: white;">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="logo.jpg" alt="AdminLTE Logo" class="brand-image img-square elevation-3" width="40" style="opacity: .8"></td>
                       <td>Data</td>
                       <td>Data</td>
                       <td>Data</td>
                       <td>Data</td>
