    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="rental.php" class="nav-link" style="background-color: #fd7e14; color: white;">
              <i class="nav-icon fas fa-biking"></i>
              <p>
                Rental
              </p>
                               ...
                               <div class="col-6">
                                <div class="form-group">
                                 <label for="exampleInputEmail1">Rental End Date</label>
                                  <input type="date" class="form-control" row="5" id="" name="re">
                                </div>
                              </div>
                               <div class="col-3">
                                <div class="form-group">
                                 <label for="exampleInputEmail1">Total Amount</label>
                                  <input type="text" class="form-control" row="5" id="" name="rental_code" placeholder="00.00">
                                </div>
                              </div>
                               <div class="col-4">
                                <div class="form-group">
                                 <label for="exampleInputEmail1">Payment Status</label>
                                  <input type="text" class="form-control" row="5" id="" name="rental_code" placeholder="Payment Status..">
                                </div>
                              </div>
                               <div class="col-5">
                                <div class="form-group">
                                 <label for="exampleInputEmail1">Rental Status</label>
                                  <input type="text" class="form-control" row="5" id="" name="rental_code" placeholder="Rental Status..">
                                </div>
                              </div>
                               <div class="col-12">
                                <div class="form-group">
                                 <label for="exampleInputEmail1">Remarks</label>
                                  <input type="text" class="form-control" row="5" id="" name="remarks" placeholder="Enter Remark..">
                                </div>
                              </div>
                              </div>
                              </div>
