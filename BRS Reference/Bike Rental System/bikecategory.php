        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
             ...
             <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="bikecategory.php" class="nav-link" style="background-color: #fd7e14; color: white;">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bike Category Data table</h3> 
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" row="5" id="" name="category_name" placeholder="Enter Category Name..">
                                </div>
