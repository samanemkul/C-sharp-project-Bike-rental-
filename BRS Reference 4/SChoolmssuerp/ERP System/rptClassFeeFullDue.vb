...
Public Class rptClassFeeFullDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_System.rptClassFeeFullDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClassFeeFullDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClassFeeFullDue = New rptClassFeeFullDue()
        rpt.Site = Me.Site
        Return rpt
    End Function
