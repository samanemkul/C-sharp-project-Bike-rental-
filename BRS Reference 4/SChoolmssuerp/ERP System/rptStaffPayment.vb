...
Public Class rptStaffPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_System.rptStaffPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_v2() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_v1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStaffPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStaffPayment = New rptStaffPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
