...
Public Class frmStaffPaymentReport
    Sub fillStaff()
        Try
            Dim CN As New SqlConnection(cs)
            CN.Open()
            adp = New SqlDataAdapter()
            adp.SelectCommand = New SqlCommand("SELECT distinct RTRIM(StaffName) FROM Staff,StaffPayment where Staff.St_ID=StaffPayment.StaffID", CN)
            ds = New DataSet("ds")
            adp.Fill(ds)
            dtable = ds.Tables(0)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Timer1.Enabled = True
            Dim rpt As New rptStaffPayment 'The report you created.
