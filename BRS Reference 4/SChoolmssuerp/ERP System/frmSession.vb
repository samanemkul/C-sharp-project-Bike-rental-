...
Public Class frmSession
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            Dim cb As String = "insert into Session_Master(Session) VALUES (@d1)"
    ...
    Private Sub DeleteRecord()
        ...
        Try
            ...
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", txtSessionName.Text)
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
    ...
    Public Sub Getdata()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Session) from Session_Master order by Session", con)
