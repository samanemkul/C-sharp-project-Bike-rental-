...
Public Class frmStaffNoDuesRecord
    Sub fillDepartment()
        Try
    ...
    Private Sub frmStaffNoDuesRecord_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        fillDepartment()
    End Sub
End Class
