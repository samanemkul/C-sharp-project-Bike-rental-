...
Public Class frmStudentsNoDuesRecord
    ...
    Private Sub btnSearch_Click(sender As System.Object, e As System.EventArgs) Handles btnSearch.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("select RTRIM(Student.AdmissionNo),RTRIM(StudentName),RTRIM(NoDues_Student.Status) from Student,Class,Section,SchoolInfo,NoDues_Student where Student.SectionID=Section.ID and Class.ClassName=Section.Class and SchoolInfo.S_ID=Student.SchoolID and Student.AdmissionNo=NoDues_Student.AdmissionNo and Session=@d1 and ClassName=@d2 and SectionName=@d3 and Student.Status='Active' order by StudentName", con)
            cmd.Parameters.AddWithValue("@d1", cmbSession.Text)
            cmd.Parameters.AddWithValue("@d2", cmbClass.Text)
