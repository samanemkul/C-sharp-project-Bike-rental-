...
public partial class SiteMaster : MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(Session["login"] != null && Session["user"] != null && Session["login"].ToString()=="true" && Session["user"].ToString() == "user" )
        {
            ...
            addbrands = "";
            addcars = "";
            bookings = "<a runat='server' href='../CustBookings' >View  Your Bookings</a>";
        ...
        else if(Session["login"] != null && Session["user"] != null && Session["login"].ToString() == "true" && Session["user"].ToString() == "admin")
        {
            ...
            addcars = "<a runat='server' href='../ManageCars' >Manage Cars</a>";
            status = "<a runat='server' href='../Logout' >Logout</a>";
        }
        else
        {
            ...
            addcars = "";
            addbrands = "";
            admin = "<a runat='server' href='../Account/AdminLogin' >Admin Login</a>";
            mssg = "<a runat='server' href='../Account/Register' >Register</a>";
            status = "<a runat='server' href='../Account/Login' >Log In</a>";
        }
    }
